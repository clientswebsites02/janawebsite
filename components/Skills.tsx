          ...
          <motion.div variants={itemVariants} className="mt-16">
            ...
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-purple-100">
              <div className="grid sm:grid-cols-3 gap-6">
                <div className="text-center p-4 rounded-xl bg-gradient-to-br from-purple-100 to-blue-100 shadow-sm">
                  ...
                  <p className="font-medium text-gray-800">Artificial Intelligence Course</p>
                </div>
                <div className="text-center p-4 rounded-xl bg-gradient-to-br from-purple-100 to-blue-100 shadow-sm">
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Code2 className="w-6 h-6 text-white" />
                  </div>
                  <p className="font-medium text-gray-800">C++ Programming Course</p>
                </div>
                <div className="text-center p-4 rounded-xl bg-gradient-to-br from-purple-100 to-blue-100 shadow-sm">
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Globe className="w-6 h-6 text-white" />
                  </div>
                  <p className="font-medium text-gray-800">HTML Course</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-16">
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-8">
              <div className="text-center">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-3 text-white text-xl md:text-2xl font-bold shadow-lg">
                  AR
                </div>
                <p className="font-semibold text-base md:text-lg text-gray-800">Arabic</p>
                <p className="text-xs md:text-sm text-gray-600">Native</p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-3 text-white text-xl md:text-2xl font-bold shadow-lg">
                  EN
                </div>
                <p className="font-semibold text-base md:text-lg text-gray-800">English</p>
                <p className="text-xs md:text-sm text-gray-600">Fluent</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
